    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <a href="{{ url('tampildatamahasiswa/' . $tampildatamahasiswa->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Datamahasiswa"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                        {!! Form::open([
                            'method'=>'DELETE',
